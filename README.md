...
├── journeys/      # end-to-end customer-lifecycle spec + its orchestration/durability/tracing backbone
├── engineering/   # coding standards, testing strategy, code review — human-driven + agent-driven pairs
