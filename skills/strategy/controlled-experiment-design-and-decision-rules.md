---
name: controlled-experiment-design-and-decision-rules
description: "Closes Group D of the workspace's product-skill gap backlog: nothing in this workspace previously told a team how to *decide whether a shipped change actually worked*. management/pdsa-improvement-cycle.md covers process."
---
...
**Minimum viable input:** the change and the metric it should move. Fix the decision rule before running anything — an experiment whose success threshold is set after the result is in is not an experiment, and that is the specific failure this skill prevents.
...
- For a pricing change → `microeconomic-pricing-and-positioning-models.md` and `../financial-impact-analysis/cost-based-pricing-floor-and-margin-governance.md` first.
- If the result changes sequencing → `../communication/roadmap-change-communication.md`.
- Before declaring a result → `../governance/verification-and-self-checking.md`.
