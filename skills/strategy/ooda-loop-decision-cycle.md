---
name: ooda-loop-decision-cycle
description: "Runs John Boyd's Observe-Orient-Decide-Act (OODA) loop as a rapid, competitive decision cycle for situations where an opponent, competitor, or adversarial condition is actively changing the environment — market entrants."
---
...
**Minimum viable input:** the situation and the decision deadline. Incomplete observation is the normal condition this skill is built for — the point is to cycle faster than the counterpart, not to observe exhaustively before acting.
...
- If the situation is a negotiation → `negotiation-concession-strategy-and-tradeoff-framework.md`.
- If the response needs a controlled test → `controlled-experiment-design-and-decision-rules.md`.
- To communicate a fast re-sequence → `../communication/roadmap-change-communication.md`.
