...
- `monetization-model-and-commercialization-levers.md`
  ...
  - Explicitly a MODEL-selection skill, not a price-LEVEL skill — hands the "how much" question to `../strategy/microeconomic-pricing-and-positioning-models.md` once a mechanism is chosen.
