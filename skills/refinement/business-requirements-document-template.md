...
description: "Provides the canonical Business Requirements Document template: why this is being done — strategic goals, revenue targets, and market positioning — at the program/investment level."
---
...
**Minimum viable input:** the program being proposed and the outcome it claims. Where the financial case is not yet built, draft the BRD with the case marked open rather than omitting it — a BRD that hides its missing business case reads as complete to the people funding it.
...
- If this is a single initiative rather than a program → `product-requirements-document-template.md`.
- For the evidence gate before funding → `../strategy/product-proposal-viability-scoring.md`.
- For the dollar-modeled comparison → `../financial-impact-analysis/revenue-cost-impact-weighted-prioritization.md`.
...
2. Fill Sections 1-9. Every revenue, market, or viability claim must cite
   its source skill/evidence (`../strategy/product-revenue-tier-investment-case.md`,
   `../strategy/product-proposal-viability-scoring.md`, competitor research) — never
   an unsourced number.
